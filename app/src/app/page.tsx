...
import DemonicPactsBadge from "../../public/img/demonic_pacts_badge.svg";
...
async function HeroSection() {
  return (
    <section className="relative flex w-full items-center justify-center bg-[#280502] py-10 md:py-0">
      <Image
        src={WomLeagueMapImage}
        alt=""
        className="absolute inset-0 top-10 mx-auto max-w-[100vw] opacity-10 lg:max-w-7xl"
      />
      ...
      <div className="flex items-center">
        <div className="flex w-auto flex-col items-start">
          <div className="z-10 flex flex-col px-5 pb-12 pt-14 md:px-14">
            <DemonicPactsBadge className="mb-2 w-36" />
            <h1 className="my-0.5 bg-gradient-to-t from-[#D71212] to-[#FE6D24] bg-clip-text text-4xl font-bold uppercase text-transparent md:my-1 lg:text-3xl xl:text-5xl">
              Wise Old Man
            </h1>
            <p className="relative mt-2 text-body text-gray-100">
              The <span className="text-primary-500">open source</span> Old School Runescape
              <br />
