            ...
            <Link
              ...
              className={cn(
                ...
                currentRouteHref === link.href &&
                  "border-primary-500 border-l-2 bg-gray-700/50 px-[1.625rem] text-white hover:bg-gray-700/50",
              )}
              onClick={onRouteSelected}
            >
        ...
        {EXTERNAL_LINKS.map((link) => (
          <li key={link.href}>
            <a
              ...
              className="flex items-center px-5 py-4 text-sm font-medium text-gray-200 hover:bg-gray-700"
            >
              <link.icon className="mr-2 h-5 w-5" />
              {link.label}
            </a>
        ...
        {LEAGUES.active && (
          <li>
            ...
            >
              ...
              <span className="text-primary-400 mt-px text-xs">New</span>
            </a>
          </li>
        )}
      </ul>
