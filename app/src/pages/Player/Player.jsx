...
import { capitalize, getSkillIcon, getPlayerTypeIcon, getOfficialHiscoresUrl, getTooltip } from '../../utils';
  ...
  return (
    <div className="player__container container">
      ...
      <div className="player__header row">
        <div className="col">
          <PageHeader title={player.username} icon={getPlayerTypeIcon(player.type)} iconTooltip={getTooltip(player.type)}>
