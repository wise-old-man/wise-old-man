...
export const CountryProps: Record<Country, { code: Country; name: string }> = {
...
export function isCountry(countryCodeString: string): countryCodeString is Country {
  return countryCodeString in CountryProps;
}

export function findCountry(countryIdentifier: string) {
