...
import { ReviewFlaggedPlayerPayload } from './instances/ReviewFlaggedPlayerJob';
...
export enum JobType {
  ...
  REVIEW_FLAGGED_PLAYER = 'REVIEW_FLAGGED_PLAYER',
...
export type JobPayload = {
  ...
  [JobType.REVIEW_FLAGGED_PLAYER]: ReviewFlaggedPlayerPayload;
