...
type FetchNameChangeDetailsParams = z.infer<typeof schema>;

type FetchNameChangeDetailsResult = {
...
class FetchNameChangeDetailsService {
  validate(payload: any): FetchNameChangeDetailsParams {
    return schema.parse(payload);
  }

  async execute(params: FetchNameChangeDetailsParams): Promise<FetchNameChangeDetailsResult> {
...
export default new FetchNameChangeDetailsService();
