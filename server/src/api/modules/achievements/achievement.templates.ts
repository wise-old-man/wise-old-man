...
export const ACHIEVEMENT_TEMPLATES: AchievementTemplate[] = [
  ...
  {
    name: "{threshold} Calvar'ion kills",
    metric: Metric.CALVARION,
    thresholds: [500, 1000, 5000, 10_000]
  },
  {
  ...
  {
    name: '{threshold} Mad Angel kills',
    metric: Metric.MAD_ANGEL,
    thresholds: [500, 1000, 5000, 10_000]
  },
  {
  ...
  {
    name: '{threshold} The Royal Titans kills',
    metric: Metric.THE_ROYAL_TITANS,
    thresholds: [500, 1000, 5000, 10_000]
  },
  {
