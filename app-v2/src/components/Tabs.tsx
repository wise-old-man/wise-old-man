...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center whitespace-nowrap rounded-t border-b border-transparent p-3 text-sm text-gray-200 transition-colors hover:text-gray-300",
