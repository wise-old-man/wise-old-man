...
async function FeaturedCompetitionWidget(props: { groupId: number }) {
  ...
  if (!featured) {
    return (
      <div className="flex h-24 w-full items-center justify-center rounded-lg border border-gray-500 px-6">
  ...
  return (
    <Link href={`/competitions/${featured.id}`}>
      <div className="group relative flex h-24 w-full items-center gap-x-4 overflow-hidden rounded-lg border border-gray-500 px-6 hover:border-gray-400">
        <Image
          alt={featured.metric}
          fill
          className="pointer-events-none z-0 object-cover transition-all duration-100 group-hover:brightness-125"
...
function FeaturedCompetitionWidgetSkeleton() {
  return (
    <div className="relative flex h-24 w-full animate-pulse items-center gap-x-4 overflow-hidden rounded-lg border border-gray-500 bg-gray-800 px-6">
...
function GroupTotalWidget(props: GroupTotalWidgetProps) {
  ...
  return (
    <div className="flex h-24 w-full flex-col items-start justify-center gap-y-1 rounded-lg border border-gray-500 px-6">
