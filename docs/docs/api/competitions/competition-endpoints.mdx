...
| Field  | Type                                               | Required | Description                                                                                                                                                                                                                                        |
| ------ | -------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| metric | [Metric](/api/global-type-definitions#enum-metric) | `false`  | An alternative metric to preview the competition's progress in. (Ex: If it's originally an `agility` competition, you can still use this param to preview what the competition would have looked like if it were a `fishing` competition instead.) When set, each participation's `deltas` will include an entry for this metric, and participants will be ranked by it. |
