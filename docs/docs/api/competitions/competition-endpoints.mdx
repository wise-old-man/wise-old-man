...
| Field   | Type                                                 | Required | Description                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------- | ---------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| preview | [Metric](/api/global-type-definitions#enum-metric)[] | `false`  | (chain multiple with ?preview=A&preview=B&preview=C) Alternative metrics to preview the competition's progress in. (Ex: If it's originally an `agility` competition, you can still use this param to preview what the competition would have looked like if it were a `fishing` competition instead.) When set, each participation's `deltas` will include an entry for these metrics, and participants will be ranked by the total of all the metrics. |

<br />

:::caution
The `progress` and `levels` fields on each participation are **deprecated** in favor of `deltas`, and will be removed in a future release. They currently mirror the entry in `deltas` that the competition is ranked by (the previewed metric's entry, the `"total"` entry for multi-metric competitions, or the single metric's entry otherwise).
:::
...
Fetches all the values (exp, kc, etc) in chronological order within the bounds of the competition, for the top participants. Returns an array of [ParticipantHistory](/api/competitions/competition-type-definitions#object-participant-history-result) objects.
...
| ------- | ---------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| preview | [Metric](/api/global-type-definitions#enum-metric)[] | `false`  | (chain multiple with ?preview=A&preview=B&preview=C) Alternative metrics to preview the competition's progress in. (Ex: If it's originally an `agility` competition, you can still use this param to preview what the competition would have looked like if it were a `fishing` competition instead.) When set, each participation's `deltas` will include an entry for these metrics, and participants will be ranked by the total of all the metrics. |
| limit   | integer                                              | `false`  | How many of the top participants to fetch the history for. Must be between `1` and `5`. Defaults to `5`.                                                                                                                                                                                                                                                                                                                                                |
