...
Fetches all previous archived player profiles that held this username. Returns an array of [PlayerArchiveWithPlayer](/players-api/player-type-definitions#object-player-archive-with-player) objects.
