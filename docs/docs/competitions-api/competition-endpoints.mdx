...
- [Players - Get Player Competition Participations](/players-api/player-endpoints#get-player-competition-participations)
- [Players - Get Player Competition Standings](/players-api/player-endpoints#get-player-competition-standings)
- [Groups - Get Group Competitions](/groups-api/group-endpoints#get-group-competitions)
...
| Field  | Type                                           | Required | Description                                                                                                                                                                                                                                        |
| ------ | ---------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| metric | [Metric](/global-type-definitions#enum-metric) | `false`  | An alternative metric to preview the competition's progress in. (Ex: If it's originally an `agility` competition, you can still use this param to preview what the competition would have looked like if it were a `fishing` competition instead.) |
