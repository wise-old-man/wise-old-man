...
Fetches all previous archived player profiles that held this username. Returns an array of [PlayerArchive](/players-api/player-type-definitions#object-player-archive) objects.
