...
> Metric is a combination of [Skill](/docs/global-type-definitions#enum-skill), [Activity](/docs/global-type-definitions#enum-activity), [Boss](/docs/global-type-definitions#enum-boss) and [ComputedMetric](/docs/global-type-definitions#enum-computed-metric)
